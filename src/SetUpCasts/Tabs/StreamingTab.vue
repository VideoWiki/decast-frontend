<template>
  <div class="wrapper">
    ...
    <div v-if="!this.ThirdPartyStreaming" class="if-third-streaming">
      ...
      <div v-if="!DropdownforFacebook" class="dropDown-for-youtube">
        <div class="box-input">
      ...
      <div v-if="!DropdownforTwich" class="dropDown-for-youtube">
        <div class="box-input">
...
export default {
  ...
  data() {
    return {
      ...
      DropdownforYoutube: true,
      DropdownforFacebook: true,
      DropdownforTwich: true,
    };
  },
  components: {
    buttonToggle,
