    ...
    <div class="tab-container">
      <div class="general">
        <div class="setting flex">
          ...
          <img v-if="!isDropdownOpen" src="@/assets/images/editor/Group.svg" @click="toggleDropdown"/>
          <img v-else src="@/assets/images/editor/Group1.svg" @click="toggleDropdown"/>
        </div>
          ...
          <div class="for-recording flex same-style">
            <div class="left-one">
              ...
              <div class="text-info">
                ...
                <p>Allow the recording of the session. Recording can be paused and restarted multiple times.</p>
              </div>
            </div>
            <div class="right-one">
      ...
      <div class="participant">
        <div class="setting flex">
          ...
          <img v-if="!isDropdownOpen2" src="@/assets/images/editor/Group.svg" @click="toggleDropdown2"/>
          <img v-else src="@/assets/images/editor/Group1.svg" @click="toggleDropdown2"/>
        </div>
          ...
          <div class="for-lock flex same-style">
            <div class="left-one">
              ...
              <div class="text-info">
                ...
                <p>Switch this on to enable viewer mode. This mode only allows user to listen to the cast.</p>
              </div>
            </div>
            <div class="right-one">
              <buttonToggle v-model="toggleValue5"></buttonToggle>
