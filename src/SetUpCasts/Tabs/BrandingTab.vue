            ...
            <div class="right">
                <div class="input-button" @click="triggerFileInput">
                    <div class="button-text">
                        <label for="fileInput" v-if="!imageSelected" class="text-one"> <p>Click to upload</p>or drag and drop your brand cover image</label>
                        <p v-if="!imageSelected" class="text-two">jpg, jpeg, png, or gif (recommended size 1440px by 600px)</p>
                    </div>
                    <input type="file" id="fileInput" @change="handleImageUpload" accept="image/*" style="display: none" ref="fileInput" />
                    <img
                        v-if="imageSelected"
                        :src="imageUrl"
                        alt="Uploaded Image"
