<template>
    <div>
        ...
        <div v-else class="cast_list flex flex-col justify-between items-start text-left mb-4 w-full py-3 px-4"
            ...
            <div v-if="castDetails.stream_urls" class="mt-6 flex flex-col justify-between gap-4 w-full">
                    ...
                    <div class="flex gap-2 justify-center items-center">
                        ...
                        <vx-tooltip
                            ...
                            <vs-button class="custm-style">
                                <img @click="copy(castDetails.public_meeting_id, undefined)"
                ...
                <div v-if="hasTwitchStream || hasYoutubeStream || hasFacebookStream"
                    ...
                    <div v-if="hasTwitchStream"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="35"
        ...
        <CreateNftGating v-else-if="activeModal === 'createNFTGating'" :closeModal="() => setActiveModal('')"
            :castDetails="castDetails" :setActiveModal="setActiveModal"
...
import FacebookStreamModal from '../../casts/components/options-components/FacebookStreamModal.vue';
import CustomCastUrl from '../../casts/components/options-components/CustomCastUrl.vue';
...
import EditBasicDetail from '../../casts/components/options-components/EditBasicDetail.vue';
import EditBrandingDetail from '../../casts/components/options-components/EditBrandingDetail.vue';
