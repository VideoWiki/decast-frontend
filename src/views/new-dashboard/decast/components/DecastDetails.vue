    ...
    <div class="parent_cast_cont_">
        ...
        <div class="flex flex-col gap-4 text-lg pt-6">
            ...
            <p v-if="localTime" class="basic_detail_cont_">>> Scheduled Time > <span class="text-white">{{ localTime }}
                    Local Time</span></p>
            <p v-else class="basic_detail_cont_">>> Scheduled Time > <span class="text-white">{{
                selectedCastId.event_time }}
                    UTC</span></p>
            ...
            <p class="basic_detail_cont_">>> Selected Storage > <span class="text-white">{{
                selectedStorage
                    }}</span></p>
        </div>
    </div>
...
export default {
    name: "DecastDetails",
    props: ['selectedCastId', 'firstCastId', 'selectedStorage','getSelectedStorage'],
    data() {
        return {
            utcTime: '00:00:00',
            localTime: null,
