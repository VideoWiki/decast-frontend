        ...
        <div class="join-body-left">
          <div class="flex flex-col video-container">
            ...
            <div class="mt-4">
              ...
              <h3 class="my-3 text-3xl font-semibold">{{ e_title }}</h3>
              <p class="text-white">{{ e_description }}</p>
...
<script>
import StreamPrivateAuth from './StreamPrivateAuth';
import HlsPlayer from '@/components/Hls-Player/HlsPlayer';
import StreamPublicAuth from './StreamPublicAuth.vue';
