    ...
    methods: {
        ...
        shareOnFacebook() {
            const url = encodeURIComponent(
                `https://decast.live/c/${this.castId}/?pass=${this.pass}`
            );
        ...
        shareOnTwitter() {
            ...
            const hashtags = encodeURIComponent('event,cool,nft,DigitalArtwork');
