<template>
    ...
    <div class="calendar-container">
        <date-pick v-model="date" :hasInputElement="true" :startWeekOnSunday="true" :isDateDisabled="isFutureDate"
            :inputAttributes="{ readonly: true }" :selectableYearRange="{ from: new Date().getFullYear(), to: 2099 }">
        </date-pick>
    </div>
  </div>
  </template>
