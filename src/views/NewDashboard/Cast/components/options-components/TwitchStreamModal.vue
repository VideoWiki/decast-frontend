            ...
            <div class="modal-content-wrapper">
                <div class="modal-content">
                    ...
                    <div class="flex flex-col mt-6 w-3/4">
                        <p class="collect-em-label">//Switch the option to true if you want to stream your cast onto Twitch
                        </p>
                        <span>twitchStreaming()</span>
                    ...
                    <div class="flex flex-col mt-6">
                        <span>//Twitch RTMP Url</span>
                        <div>
                            <input class="w-2/5 p-2 mt-2" placeholder="//RTMP URL" type="text" v-model="twitch"
                                @keyup="urlError = twitch === ''" />
                            <p v-if="urlError" class="text-danger my-2 p-0">>> RTMP URL is required</p>
                        </div>
                    </div>

                    <div class="flex flex-col mt-6">
                        <span>//Twitch Secret Key</span>
                        <div>
                            <input class="w-2/5 p-2 mt-2" placeholder="//Secret Key" type="text" v-model="twitchSecret"
                                @keyup="secretKeyError = twitchSecret === ''" />
