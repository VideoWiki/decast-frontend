  ...
  >
    <div class="inner-div1">
      ...
      <div v-if="cast.invitee_list.length === 0" class="inner-child2">
        <span class="invite-text" href="#" @click="openInviteAttendeesModal"
  ...
  <div v-else class="child-options">
    <div class="inner-div1">
      ...
      <div
        ...
        class="inner-child2"
        @click="openInviteAttendeesModal"
      >
    ...
    <NftEdit
      v-if="activeModal === 'editNft'"
      :closeModal="() => setCastModal('manageAudienceModal')"
      :cast_id="cast.public_meeting_id"
    />
    <ShareNftLink
      v-else-if="activeModal === 'shareNft'"
      :closeModal="() => setCastModal('manageAudienceModal')"
      :cast_id="cast.public_meeting_id"
    />

    <BaseModal
      v-if="activeModal == 'manageAudienceModal'"
      :title="'Invite your attendees'"
      @close="setCastModal('')"
    >
      <template #modalContent>
        <ManageAudNftModal
          :showCloseButton="() => setCastModal('')"
          :isAirdrop="isAirdrop"
          :setCastModal="setCastModal"
          ...
          :invites="cast.invitee_list"
          :isStream="typeof streamInfo[cast.public_meeting_id] !== 'undefined'"
          :viewer="cast.viewer_mode"
        />
      </template>
    </BaseModal>
    <CallSettingsModal
      v-if="activeModal == 'callSettingsModal'"
    ...
    />
    <StreamSettingsModal
      v-if="activeModal == 'streamingModal'"
      :closeModal="() => setCastModal('')"
      :stepFourProps="stepFourProps"
      :stepThreeProps="stepThreeProps"
      :stepTwoProps="stepTwoProps"
    ...
    />
    <ResheduleCastModal
      v-if="activeModal == 'resheduleCastModal'"
      :closeModal="() => setCastModal('')"
      :cast_id="cast.public_meeting_id"
      :cast_name="castsInfo[cast.public_meeting_id].details.event_name"
      :allow_moderator_to_unmute_user="
        castsInfo[cast.public_meeting_id].details.allow_moderator_to_unmute_user
      "
      :auto_start_recording="
        castsInfo[cast.public_meeting_id].details.auto_start_recording
      "
      ...
      :collect_attendee_email="
        castsInfo[cast.public_meeting_id].details.collect_attendee_email
      "
      ...
      :moderator_only_text="
        castsInfo[cast.public_meeting_id].details.moderator_only_text
      "
      ...
      :end_when_no_moderator="
        castsInfo[cast.public_meeting_id].details.end_when_no_moderator
      "
      :mute_on_start="castsInfo[cast.public_meeting_id].details.mute_on_start"
      :webcam_only_for_moderator="
        castsInfo[cast.public_meeting_id].details.webcam_only_for_moderator
      "
    ...
    <ResheduleCastModal
      v-if="activeModal == 'postponeCastModal'"
      :closeModal="() => setCastModal('')"
      :cast_id="cast.public_meeting_id"
      :cast_name="castsInfo[cast.public_meeting_id].details.event_name"
      :allow_moderator_to_unmute_user="
    ...
    />
    <EditCastModal
      v-if="activeModal == 'editCastModal'"
      :closeModal="() => setCastModal('')"
      :cast_id="cast.public_meeting_id"
      :getCast="getCastList"
    />
    ...
    <ConfirmationModal
      v-if="activeModal === 'deleteCastModal'"
      :title="'Delete cast'"
      :description="'Do you really want to delete this cast?'"
      :onConfirm="() => deleteCast(cast.public_meeting_id)"
      :closeModal="() => setCastModal('')"
    />
  </div>
</template>
