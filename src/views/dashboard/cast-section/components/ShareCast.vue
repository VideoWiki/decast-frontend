<template>
    <div class="margin">
        ...
        <div class="my-5 flex justify-center bottom">
          ...
          <img src="@/assets/images/create-event/tabler.svg" /> Add drops
            ...
            <button @click="changeStatus('drops')" class="success-btn button flex items-center">
                <img src="@/assets/images/create-event/tabler-icon.svg" />Add drops
            </button>
        ...
        <div class="skip cursor-pointer" @click="toggleCreateCastModal">
            Skip for now
...
export default {
    ...
    props: ['toggleCreateCastModal', 'changeStatus'],
    mounted() {
        this.getCastList();
