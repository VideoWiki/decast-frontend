<template>
    <BaseModal :title="'Share setting'" @close="closeModal">
        <template #modalContent>
            <div class="wrapper">
                <!-- <div v-if="castId !== ''" class="head-container">
                    <h3>Share setting</h3>
            ...
            <label class="slider"></label>
                ...
                <div class="lower-wrap">
                    ...
                    <div class="third-party flex" @click="ChangeStream">
                        ...
                        <img v-if="ThirdPartyStreaming" src="@/assets/images/editor/Vector24.svg" />
                        <img v-if="!ThirdPartyStreaming" src="@/assets/images/editor/Vector25.svg" />
                    </div>
                    <div class="horizontal-line"></div>
                </div>
                <div v-if="!ThirdPartyStreaming" class="if-third-streaming">
                ...
                <div class="buttonn cursor-pointer">
                    <button v-if="castId !== ''" class="cursor-pointer" @click="AddStream">
                        Add streaming
                    </button>
